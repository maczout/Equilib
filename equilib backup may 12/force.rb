...
module JM::Equilib
  ...
  class Force 
    ...
    class Visualization 
      ...
      @definition_names                                   = {}
      @definition_names[true]                             = {}
      @definition_names[true][-1]                         = 'Equilib_ForceInternalVisualization'
      @definition_names[true][0]                          = 'Equilib_ForceInternalVisualization'
      @definition_names[true][+1]                         = 'Equilib_ForceInternalVisualization'
      @definition_names[false]                            = {}
      @definition_names[false][-1]                        = 'Equilib_ForceExternalPushVisualization'
      @definition_names[false][0]                         = 'Equilib_ForceExternalPushVisualization'
      @definition_names[false][+1]                        = 'Equilib_ForceExternalPullVisualization'     
