...
module JM::Equilib
  ...
  class Sandbox
    ...
    @definition_name_map['Equilib_ForceExternalPushVisualization'] = JM::Equilib::Force::Visualization
    @definition_name_map['Equilib_ForceExternalPushVisualization'] = JM::Equilib::Force::Visualization
    @definition_name_map['Equilib_ForceExternalPullVisualization'] = JM::Equilib::Force::Visualization
    ...
    def j;  joints_map.values;  end
    def forces_map;       @components_map[JM::Equilib::Force];  end
    def f;  forces_map.values;  end
